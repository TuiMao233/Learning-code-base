...
![1574341010](images/vue/1574341010.png)
...
3. 在 utils.ts 中定义 renderInstance 方法（渲染实例）
...
7. 在模板上使用
   ...
   <template>
     ...
     <modal @clone="onClone" @confirm="onConfirm" v-model="show" >
       啦啦啦我是自定义内容
     </modal>
   </template>
