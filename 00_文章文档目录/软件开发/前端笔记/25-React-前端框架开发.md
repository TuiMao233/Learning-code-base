...
1. **绑定动态数据：**![1](images/React/input/1.jpg)![2](images/React/input/2.jpg)*（此时input的值是固定的）*
2. **input绑定输入事件：**![3](images/React/input/3.jpg)
3. **根据input的值改变动态数据：**![4](images/React/input/4.jpg)

## 生命周期钩子

![图片1](images/React/tupian1.png)
...
![子组件传递数据](images/React/asd12emasdasdpmas.jpg)
...
![消息订阅系统](images/React/asd12empmas.jpg)
...
![rudex调试工具](images/React/rudex2d12d12e1e1.jpg)
