<template>
  <div class="audio_player" v-if="playerSongList[songIndex]">
    <div class="left-controls">
      <el-image class="album_img" :src="playerSongList[songIndex].album_img_path" fit="cover"/>
    ...
    <audio
      :src="playerSongList[songIndex].audio_path"
      ref="audio"
...
export default {
  ...
  methods: {
    ...
    toggleAudiostatus() {
      ...
      if (isNaN(this.$refs.audio.duration)) return false;
      // 切换音频状态(播放/暂停)
