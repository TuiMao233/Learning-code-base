...
<template>
  <el-card class="box-card-personal">
    ...
    <el-upload
      ...
      :auto-upload="false"
    >
      <div v-if="imageUrl" :style="{backgroundImage:`url(${imageUrl})`}" class="updata_avatar_img"></div>
      <div
        v-else-if="userInfo.avatar_file_path"
        :style="{backgroundImage:`url(${userInfo.avatar_file_path})`}"
        class="avatar_img"
      ></div>
