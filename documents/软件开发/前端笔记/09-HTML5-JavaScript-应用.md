...
<img src=" img/HTM5_JavaScript/1.png" alt="1" style="zoom:67%;float:left" />
...
<img src=" img/HTM5_JavaScript/2.png" alt="2" style="zoom:67%;float:left" />
...
<img src=" img/HTM5_JavaScript/3.png" alt="3" style="zoom: 67%; float: left;" />`arc(x, y, radius, startAngle, endAngle, anticlockwise)`
以`x，y`为圆心
以`radius`为半径的圆弧（圆）
...
`ctx.moveTo(x0,y0)`<img src=" img/HTM5_JavaScript/4.png" alt="4" style="zoom: 67%; float: left;" />
...
`ctx.moveTo(x0,y0)`<img src=" img/HTM5_JavaScript/5.png" alt="5" style="zoom: 33%; float: left;" />
...
<img src=" img/HTM5_JavaScript/6.png" alt="6" style="zoom: 50%;float: left;" />
...
canvas默认的瞄点为`0,0`但可以设置瞄点在某个地方<img src=" img/HTM5_JavaScript/7.png" alt="7" style="zoom: 25%; float: left;" />
`ctx.translate(x,y)`
...
`ctx.rotate(弧度)` <img src=" img/HTM5_JavaScript/8.png" alt="8" style="zoom:33%;float:left" />
...
`ctx.drawImage(image,x,y,width,height)`<img src=" img/HTM5_JavaScript/9.png" alt="9" style="zoom: 33%; float: left;" />
...
<img src=" img/HTM5_JavaScript/10.png" alt="10" style="zoom:50%;float:left" /> `ctx.createPattern(image,repetition)`
...
`var gradient = ctx.createLinearGradient(x1,y1,x2,y2)`<img src=" img/HTM5_JavaScript/11.png" alt="11" style="zoom: 50%; float: left;" />
...
`createRadialGradient(x1,y1,r1,x2,y2,r2)`<img src=" img/HTM5_JavaScript/12.png" alt="12" style="zoom: 33%; float: left;" />
...
选取一个马赛克矩形<img src=" img/HTM5_JavaScript/13.png" alt="13" style="zoom: 80%;float:left" />
...
![1583247935(1)](images/HTM5_JavaScript/1583247935(1).jpg)
