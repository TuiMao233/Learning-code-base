...
// TS 函数中必须指定返回值
function say_hi1() { return 'hi, 你好呀~'; }
var say_hi2 = function () { return 'hi, 你好呀~'; };
var re1 = say_hi1();
var re2 = say_hi2();
// TS 函数中不需要返回值时需指定void
function say_hi3() { console.log('hi啥, 讨厌, 死鬼~~~~'); }
var say_hi4 = function () { return console.log('hi啥, 讨厌, 死鬼~~~~'); };
...
var user_name_1 = 'uzi'; // --> let user_name_1:string = 'uzi'
